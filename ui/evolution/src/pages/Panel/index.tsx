            ...
            <div className="min-h-full">
                <nav className="bg-gray-800">
                    ...
                    <div className="md:hidden" id="mobile-menu">
                        <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                            <a href="#"
                                className={`block rounded-md px-3 py-2 text-base font-medium ${activeTab === 'painel' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}`}
                                onClick={() => setActiveTab('painel')}
                                aria-current="page">
                                Painel
                            </a>
                            <a href="#"
                                className={`block rounded-md px-3 py-2 text-base font-medium ${activeTab === 'clients' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}`}
                                onClick={() => setActiveTab('clients')}>
                                Clientes
                            </a>
                            <a href="#" className={`block rounded-md px-3 py-2 text-base font-medium ${activeTab === 'posts' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}`} onClick={() => setActiveTab('posts')}>Comunicação</a>
                            <a href="#" className={`block rounded-md px-3 py-2 text-base font-medium ${activeTab === 'loans' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}`} onClick={() => setActiveTab('loans')}>Empréstimos</a>
                        </div>
                        <div className="border-t border-gray-700 pb-3 pt-4">
                            ...
                            <div className="mt-3 space-y-1 px-2">
                                <a href="#" onClick={handleSignOut} className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Sign out</a>
                            </div>
                        </div>
                    </div>
                </nav>
                ...
                <header className="bg-white shadow">
                    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                        <h1 className="text-2xl font-extralight text-gray-900">Plataforma de Monitoramento</h1>
                    </div>
                </header>
