    ...
    <>
      ...
      <Section className="relative overflow-x-hidden">
        ...
        <PageContainer className="relative z-20">
          <section className="flex flex-col-reverse md:flex-row items-center justify-between min-h-[60vh] gap-4 p-4 md:p-10">
      ...
      <div className="relative p-6 w-full max-w-lg md:max-w-7xl bg-white rounded-3xl shadow-lg z-30 -mt-12 mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div data-aos="zoom-in" className="flex-1 text-center md:text-left">
            ...
            <button className="bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 md:py-3 px-6 md:px-8 rounded-lg shadow-lg text-base md:text-lg mt-6 transition-all duration-300">
              Começar a investir
            </button>
          </div>
        </div>
