...
const FinancialConsulting: React.FC = () => {
    return (
        <div className="relative isolate bg-gray-50 px-6 py-16 sm:py-24 lg:px-8">
            <div className="mx-auto max-w-7xl text-center">
                <h2 className="text-base font-semibold text-indigo-600">Serviço de Consultoria</h2>
                <p className="mt-4 font-bold tracking-tight text-gray-900 text-2xl md:text-5xl">Consultoria Financeira Personalizada</p>
                <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600 sm:text-xl/8">
            ...
            <div className="mt-16 grid gap-10 lg:grid-cols-3 lg:gap-8 px-3 max-w-4xl mx-auto">
                <div className="rounded-lg bg-white shadow-lg p-8 ring-1 ring-gray-200">
                    <h3 className="text-lg font-medium text-indigo-600">Planejamento Financeiro</h3>
                ...
                <div className="rounded-lg bg-indigo-600 p-8 shadow-lg text-white ring-1 ring-indigo-500">
                    <h3 className="text-lg font-medium">Gerenciamento de Risco</h3>
                ...
                <div className="rounded-lg bg-white shadow-lg p-8 ring-1 ring-gray-200">
                    <h3 className="text-lg font-medium text-indigo-600">Apoio em Decisões</h3>
                    <p className="mt-4 text-base text-gray-600">
